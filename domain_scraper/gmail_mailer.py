...
class GmailMailer:
    ...
    def __init__(self, dbfile, subscribers):
        ...
        try:
            ...
            logger.error("Please set missing env variable for script to work: %s", str(err))
    ...
    def send_email(self, all_emails=False):
        ...
        try:
            ...
            logger.warning("DB FILE missing: (%s). Please run domain scraping first", err.filename)
            return False
